package  
{
	...
	public class NPC extends FlxSprite
	{
		...
		// for behavior: 0 = stand; 1 = walk in place; 2 = walk around randomly
		
		public function NPC(X:int, Y:int, p:Player, my_text:int = 0, msg_group:FlxGroup = null, my_graphic_id:int = 0, my_dir:int = 0, behavior:int = 0, switch_id:int = -1, requiredSwitch:int = -1, switch_alt_id:int = -1, alt_text_id:int = 0)
		{
			...
			if (StatsTable.Switch[switch_alt_id] == 1)
				...
				text = DataTable.Messages[my_text];
