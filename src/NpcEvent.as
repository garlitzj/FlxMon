package  
{
	...
	{		
		...
		public function NpcEvent(X:int, Y:int, p:Player, my_text:String = "", msg_group:FlxGroup = null, my_graphic_id:int = 0, my_dir:int = 0, switch_id:int = -1, myMusic:Class = null)
		{
